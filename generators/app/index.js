...
export default class extends Generator {
    ...
    writing() {
        ...
        // this.fs.copyTpl(
        //     this.templatePath('hero-desktop.png'),
        //     this.destinationPath('hero-desktop.png')
        // );
        ...
        this.fs.copy(
            ...
            this.answers.srcDir ? this.destinationPath(`src/app`) : this.destinationPath(`app`)
        );
    ...
    install() {
        ...
        this.log('******************************************')
        this.log(`Run the project: cd ${this.answers.componentName} then 'npm run dev'`)
        this.log(`Seed the SQLite db: cd ${this.answers.componentName}/app then 'node connect.js'`)
        this.log('******************************************')
    }
}
